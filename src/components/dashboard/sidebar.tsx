...
const adminNavigation = [
  ...
  { key: "nav.integrations", href: "/admin/integrations", icon: LinkIcon },
...
const developerNavigation = [
  { key: "nav.developerPortal", href: "/developers", icon: CodeBracketIcon },
  { key: "nav.apiDocs", href: "/developers/docs", icon: DocumentTextIcon },
  { key: "nav.apiSupport", href: "/developers/support", icon: ChatBubbleIcon },
];
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 hidden w-64 flex-col border-r border-gray-200 bg-white lg:flex">
      ...
      <nav className="flex-1 space-y-1 px-3 py-4">
        ...
        <div className="mt-6 space-y-1">
          <p className="px-3 text-xs font-semibold uppercase tracking-wider text-gray-500">
            {t("sections.tipVerification")}
          </p>
          {tipVerificationNavigation.map((item) => (
            <Link
              key={item.key}
              href={item.href}
              className={cn(
        ...
        <div className="mt-6 space-y-1">
          <p className="px-3 text-xs font-semibold uppercase tracking-wider text-gray-500">
            {t("sections.familySupport")}
          </p>
          {familySupportNavigation.map((item) => (
            <Link
              key={item.key}
              href={item.href}
              className={cn(
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500 truncate">admin@locateconnect.com</p>
          </div>
        </div>
      </div>
    </aside>
